...
} from "./chunk-PJPUYGT2.js";
import {
  useThemeProps
} from "./chunk-D75S3YGD.js";
import {
  CacheProvider,
  Global,
  StyleSheet,
...
var HighlightedContext = React24.createContext({
  isInitialized: false,
  data: {
...
function HighlightedProvider({
  ...
  const series = useSeries();
  const seriesById = React26.useMemo(() => {
  ...
  const providerValue = React26.useMemo(() => {
    return {
      isInitialized: true,
      data: {
        highlightScope,
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react9.forwardRef)((givenProps, givenRef) => {
    ...
    return React27.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React28.createElement(Provider, { value: props }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React28.createContext(init));
...
function useTransition(data, props, deps) {
  ...
  const renderTransitions = (render) => React29.createElement(React29.Fragment, null, transitions.map((t, i) => {
    const { springs } = changes.get(t) || t.ctrl;
    const elem = render({ ...springs }, t.item, t, i);
    return elem && elem.type ? React29.createElement(
      elem.type,
      {
        ...elem.props,
...
var AnimationContext = React30.createContext({
  isInitialized: false,
  data: {
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React31.useContext(AnimationContext);
  if (!isInitialized) {
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React32.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
...
var InteractionContext = React33.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React33.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React33.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React34.useRef({
    isInChart: false,
    x: -1,
    y: -1
  });
...
var ChartsSurface = React35.forwardRef(function ChartsSurface2(inProps, ref) {
  ...
  return (0, import_jsx_runtime10.jsxs)(ChartChartsSurfaceStyles, _extends({
    width: width2,
    height: height2,
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime11.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime11.jsxs)(React36.Fragment, {
...
function useChartGradient() {
  const {
    chartId
  } = React38.useContext(DrawingContext);
  return React38.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
var ChartContainer = React41.forwardRef(function ChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime14.jsx)(DrawingProvider, _extends({}, drawingProviderProps, {
    children: (0, import_jsx_runtime14.jsx)(PluginProvider, _extends({}, pluginProviderProps, {
      children: (0, import_jsx_runtime14.jsx)(SeriesProvider, _extends({}, seriesProviderProps, {
        children: (0, import_jsx_runtime14.jsx)(CartesianProvider, _extends({}, cartesianProviderProps, {
          children: (0, import_jsx_runtime14.jsx)(ZAxisContextProvider, _extends({}, zAxisContextProps, {
            children: (0, import_jsx_runtime14.jsx)(InteractionProvider, {
              children: (0, import_jsx_runtime14.jsx)(HighlightedProvider, _extends({}, highlightedProviderProps, {
                children: (0, import_jsx_runtime14.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
                  children: [(0, import_jsx_runtime14.jsx)(ChartsAxesGradients, {}), (0, import_jsx_runtime14.jsx)(AnimationProvider, _extends({}, animationProviderProps, {
                    children
                  }))]
                }))
              }))
...
var ResponsiveChartContainer = React43.forwardRef(function ResponsiveChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime15.jsx)(ResizableContainer, _extends({}, resizableChartContainerProps, {
    children: hasIntrinsicSize ? (0, import_jsx_runtime15.jsx)(ChartContainer, _extends({}, chartContainerProps)) : null
  }));
});
true ? ResponsiveChartContainer.propTypes = {
   ...
   * If not provided, the container supports line, bar, scatter and pie charts.
   */
  plugins: import_prop_types6.default.arrayOf(import_prop_types6.default.object),
  /**
   ...
   * The configuration of the z-axes.
   */
  zAxis: import_prop_types6.default.arrayOf(import_prop_types6.default.shape({
    colorMap: import_prop_types6.default.oneOfType([import_prop_types6.default.shape({
      colors: import_prop_types6.default.arrayOf(import_prop_types6.default.string).isRequired,
      type: import_prop_types6.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types6.default.string,
...
function deepClone(source) {
  if (React51.isValidElement(source) || (0, import_react_is.isValidElementType)(source) || !isPlainObject(source)) {
    return source;
  }
  const output = {};
...
function deepmerge(target, source, options = {
  ...
  if (isPlainObject(target) && isPlainObject(source)) {
    Object.keys(source).forEach((key) => {
      if (React51.isValidElement(source[key]) || (0, import_react_is.isValidElementType)(source[key])) {
...
function createBox(options = {}) {
  ...
  const Box2 = React53.forwardRef(function Box3(inProps, ref) {
...
var useEnhancedEffect = typeof window !== "undefined" ? React54.useLayoutEffect : React54.useEffect;
...
var PropsContext = React59.createContext(void 0);
...
function useGlobalId(idOverride) {
  const [defaultId, setDefaultId] = React60.useState(idOverride);
...
function isMuiElement(element, muiNames) {
  var _a, _b, _c;
  return React65.isValidElement(element) && muiNames.indexOf(
  ...
  const Grid2 = React66.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime31.jsx)(GridRoot, {
      ...
      children: React66.Children.map(children, (child) => {
        var _a;
        if (React66.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React71.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React71.useMemo(() => {
...
function LegendPerItem(props) {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React76.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
...
function useAxis({
  ...
  const {
    zAxis,
    zAxisIds
  } = React79.useContext(ZAxisContext);
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime42.jsxs)(React80.Fragment, {
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime44.jsxs)(React82.Fragment, {
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-H5BRYNW3.js.map
